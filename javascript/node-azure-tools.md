...
![用來管理 Azure 資源的 Azure CLI](media/node-azure-tools/azure-cli.png)
...
![使用 Visual Studio Code 編輯 JavaScript](media/node-azure-tools/visual-studio-code-debug-javascript.png)
